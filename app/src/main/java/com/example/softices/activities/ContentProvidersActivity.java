...
import com.example.softices.adapter.AllContactsAdapter;
...
public class ContentProvidersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * existing device read contact permission
         */
    ...
    /**
     * getAllContacts method use to fatch all contact in this device
     */
    private void getAllContacts() {
        ArrayList<ContactModel> contactVOList = new ArrayList<>();
